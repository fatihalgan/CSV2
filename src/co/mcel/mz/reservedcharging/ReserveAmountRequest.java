 ...
 */
            ...
            /**
            *  ReserveAmountRequest bean class
            */
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                        ...
                        /**
                        * field for RequesterService
                        */

                        
                                    protected java.lang.String localRequesterService ;
                           ...
                           * @return java.lang.String
                           */
                           public  java.lang.String getRequesterService(){
                               return localRequesterService;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param RequesterService
                               */
                               public void setRequesterService(java.lang.String param){
                            
                                            this.localRequesterService=param;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       ReserveAmountRequest.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":reserveAmountRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "reserveAmountRequest",
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"requesterService", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"requesterService");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("requesterService");
                                    }
                                

                                          if (localRequesterService==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("requesterService cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(localRequesterService);
                            ...
                            elementList.add(new javax.xml.namespace.QName("",
                                    ...
                                    elementList.add(localMsisdn);
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("",
                                        ...
                                        if (localRequesterService != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localRequesterService));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("requesterService cannot be null!!");
                                        }
    ...
    public static class Factory{
        ...
        */
        public static ReserveAmountRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ReserveAmountRequest object =
                new ReserveAmountRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"reserveAmountRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ReserveAmountRequest)co.mcel.mz.reservedcharging.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","requesterService").equals(reader.getName())){
                                
                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setRequesterService(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
