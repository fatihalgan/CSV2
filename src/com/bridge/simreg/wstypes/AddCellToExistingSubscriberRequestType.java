...
/**
 * AddCellToExistingSubscriberRequestType.java
 *
 ...
 */
            ...
            /**
            *  AddCellToExistingSubscriberRequestType bean class
            */
        
        public  class AddCellToExistingSubscriberRequestType
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = addCellToExistingSubscriberRequestType
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       AddCellToExistingSubscriberRequestType.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":addCellToExistingSubscriberRequestType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "addCellToExistingSubscriberRequestType",
                           xmlWriter);
                   }
                                        ...
                                        xmlWriter.writeStartElement("subscriberInfoId");
                                          ...
                                          if (localSubscriberInfoId==null){
                                              // write the nil attribute
                                                     ...
                                                     throw new org.apache.axis2.databinding.ADBException("subscriberInfoId cannot be null!!");
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://www.bridge.com/simreg",
                                    ...
                                    elementList.add(localCellNumber);
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://www.bridge.com/simreg",
                                        ...
                                        if (localSubscriberInfoId != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localSubscriberInfoId));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("subscriberInfoId cannot be null!!");
                                        }
    ...
    public static class Factory{
        ...
        */
        public static AddCellToExistingSubscriberRequestType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AddCellToExistingSubscriberRequestType object =
                new AddCellToExistingSubscriberRequestType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"addCellToExistingSubscriberRequestType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AddCellToExistingSubscriberRequestType)com.bridge.simreg.wstypes.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
