 ...
 */
            ...
            /**
            *  VoucherTopUpRequest bean class
            */
        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected java.lang.String localActivationCode ;
                           ...
                           */
                           public  java.lang.String getActivationCode(){
                            ...
                            /**
                               ...
                               */
                               public void setActivationCode(java.lang.String param){
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       VoucherTopUpRequest.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":voucherTopUpRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "voucherTopUpRequest",
                           xmlWriter);
                                    ...
                                    if (! namespace.equals("")) {
                                        ...
                                        if (prefix == null) {
                                            ...
                                            xmlWriter.writeStartElement(prefix,"activationCode", namespace);
                                            xmlWriter.writeNamespace(prefix, namespace);
                                            xmlWriter.setPrefix(prefix, namespace);

                                        } else {
                                            xmlWriter.writeStartElement(namespace,"activationCode");
                                        }

                                    } else {
                                        xmlWriter.writeStartElement("activationCode");
                                    }
                            ...
                            elementList.add(new javax.xml.namespace.QName("",
                                    ...
                                    elementList.add(localMsisdn);
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("",
                                        ...
                                        if (localActivationCode != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localActivationCode));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("activationCode cannot be null!!");
                                        }
    ...
    public static class Factory{
        ...
        */
        public static VoucherTopUpRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            VoucherTopUpRequest object =
                new VoucherTopUpRequest();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"voucherTopUpRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (VoucherTopUpRequest)com.bridge.netmovel.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
