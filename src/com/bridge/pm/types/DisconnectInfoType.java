 ...
 */
            ...
            /**
            *  DisconnectInfoType bean class
            */
        
        public  class DisconnectInfoType
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = disconnectInfoType
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
       ...
       public org.apache.axiom.om.OMElement getOMElement (
               ...
               org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       DisconnectInfoType.this.serialize(parentQName,factory,xmlWriter);
                 }
               };
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":disconnectInfoType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "disconnectInfoType",
                                    ...
                                    if (localCardProfile==null){
                                        ...
                                        if (! namespace2.equals("")) {
                                            ...
                                            if (prefix2 == null) {
                                                ...
                                                xmlWriter.writeStartElement(prefix2,"cardProfile", namespace2);
                                                xmlWriter.writeNamespace(prefix2, namespace2);
                                                xmlWriter.setPrefix(prefix2, namespace2);

                                            } else {
                                                xmlWriter.writeStartElement(namespace2,"cardProfile");
                                            }

                                        } else {
                                            xmlWriter.writeStartElement("cardProfile");
                                        }
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://www.bridge.com/pm/types",
                                    ...
                                    elementList.add(localMsisdn);
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://www.bridge.com/pm/types",
                                         ...
                                         elementList.add(localSim==null?null:
                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localSim));
                                    
                            elementList.add(new javax.xml.namespace.QName("http://www.bridge.com/pm/types",
                                                                      "cardProfile"));
                            
                            
                                    elementList.add(localCardProfile==null?null:
                                    localCardProfile);
    ...
    public static class Factory{
        ...
        */
        public static DisconnectInfoType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DisconnectInfoType object =
                new DisconnectInfoType();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"disconnectInfoType".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DisconnectInfoType)com.bridge.pm.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
